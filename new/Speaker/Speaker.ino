...
void setup()
{
 ...
 Serial.flush(); 
  ...
  Serial.println(mp3.getCommandStatus()); //1=module busy, 2=module sleep, 3=request not fully received, 4=checksum not match
   ...
   Serial.println("vvvvvvvvvvvvvvvvvvvvv");                                       //11=OK command accepted, 12=OK playback completed, 13=OK module ready after reboot
...
//mp3.playFolder(1, 2); //1=folder/2=track, folder name must be 01..99 & files in folder must start with 3 decimal digits with leading zeros
 Serial.println("playTrack");                                       //11=OK command accepted, 12=OK playback completed, 13=OK module ready after reboot
Serial.println(mp3.getStatus()); 
  delay(10000);         //play for 60 seconds

  mp3.pause();
 Serial.println("pause");                                       //11=OK command accepted, 12=OK playback completed, 13=OK module ready after reboot
Serial.println(mp3.getStatus()); 
